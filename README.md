...
Check the [releases](https://github.com/droboports/headphones/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/headphones.git
cd headphones
./build.sh
ls -la *.tgz
```
